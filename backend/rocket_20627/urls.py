"""rocket_20627 URL Configuration
...
admin.site.site_header = "Rocket"
admin.site.site_title = "Rocket Admin Portal"
admin.site.index_title = "Rocket Admin"

# swagger
api_info = openapi.Info(
    title="Rocket API",
    default_version="v1",
    description="API documentation for Rocket App",
)
